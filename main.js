...
function navigateTo(page, param) {
  ...
  switch (page) {
    ...
    case 'ikm':
      ...
      break;
    case 'fullmenu':
      renderFullMenuPage(content, param);
      break;
    case 'profile':
...
function renderHomePage(container) {
  ...
  container.innerHTML = `
    ...
    <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-900 via-emerald-800 to-teal-900 text-white shadow-2xl p-8 sm:p-12 mb-10 border border-emerald-700/50">
      ...
      <div class="max-w-3xl relative z-10">
        ...
        <div class="flex flex-wrap items-center gap-3">
          <button onclick="navigateTo('fullmenu')" class="px-6 py-3.5 rounded-2xl bg-amber-400 text-emerald-950 font-bold text-sm shadow-lg hover:bg-amber-300 transition flex items-center gap-2 transform active:scale-95">
            <i data-lucide="grid" class="w-4 h-4"></i> Menu Lengkap Aplikasi
          </button>
          <button onclick="navigateTo('services')" class="px-6 py-3.5 rounded-2xl bg-emerald-700/80 hover:bg-emerald-700 text-white font-semibold text-sm border border-emerald-500/40 transition flex items-center gap-2">
            <i data-lucide="layers" class="w-4 h-4"></i> 48 Standar Layanan
          </button>
          <button onclick="navigateTo('track')" class="px-6 py-3.5 rounded-2xl bg-emerald-800/60 hover:bg-emerald-800 text-white font-semibold text-sm border border-emerald-500/30 transition flex items-center gap-2">
            <i data-lucide="search" class="w-4 h-4"></i> Lacak Berkas
          </button>
        </div>
      </div>
    </div>
    ...
    <!-- Quick Menu Lengkap Grid (Akses Cepat Tampilan Screenshot) -->
    <div class="mb-12 bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-sm">
      <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-2 mb-6 pb-4 border-b border-slate-100">
        <div class="flex items-center gap-3">
          <div class="w-10 h-10 rounded-2xl bg-red-100 text-red-700 flex items-center justify-center font-bold">
            <i data-lucide="grid" class="w-5 h-5"></i>
          </div>
          <div>
            <h3 class="text-lg sm:text-xl font-bold text-slate-900">Menu Lengkap & Kepegawaian</h3>
            <p class="text-xs text-slate-500">Aplikasi kepegawaian internal & akses cepat layanan terpadu KUA Biringbulu</p>
          </div>
        </div>
        <button onclick="navigateTo('fullmenu')" class="self-start sm:self-auto px-4 py-2 rounded-xl bg-red-50 hover:bg-red-100 text-red-700 border border-red-200 font-bold text-xs transition flex items-center gap-1.5">
          <span>Buka Tampilan Penuh</span>
          <i data-lucide="chevron-right" class="w-4 h-4"></i>
        </button>
      </div>

      <!-- 9 Ikon Kepegawaian Utama (Sesuai Screenshot) -->
      <div class="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-9 gap-4 text-center">
        <div onclick="navigateTo('profile')" class="group flex flex-col items-center cursor-pointer select-none">
          <div class="w-16 h-16 rounded-2xl bg-red-50 group-hover:bg-red-100 border border-red-200/60 flex items-center justify-center shadow-sm group-hover:scale-105 transition mb-2">
            <i data-lucide="clipboard-check" class="w-7 h-7 text-red-700 stroke-[2.2]"></i>
          </div>
          <span class="text-[11px] font-semibold text-slate-700 group-hover:text-red-700 transition">SIPAKATAU</span>
        </div>

        <div onclick="navigateTo('profile')" class="group flex flex-col items-center cursor-pointer select-none">
          <div class="w-16 h-16 rounded-2xl bg-amber-50 group-hover:bg-amber-100 border border-amber-200/60 flex items-center justify-center shadow-sm group-hover:scale-105 transition mb-2">
            <i data-lucide="calendar" class="w-7 h-7 text-amber-600 stroke-[2.2]"></i>
          </div>
          <span class="text-[11px] font-semibold text-slate-700 group-hover:text-amber-600 transition leading-tight">Absensi Kegiatan</span>
        </div>

        <div onclick="navigateTo('profile')" class="group flex flex-col items-center cursor-pointer select-none">
          <div class="w-16 h-16 rounded-2xl bg-emerald-50 group-hover:bg-emerald-100 border border-emerald-200/60 flex items-center justify-center shadow-sm group-hover:scale-105 transition mb-2">
            <i data-lucide="receipt" class="w-7 h-7 text-emerald-600 stroke-[2.2]"></i>
          </div>
          <span class="text-[11px] font-semibold text-slate-700 group-hover:text-emerald-600 transition">Tukin/LP</span>
        </div>

        <div onclick="navigateTo('profile')" class="group flex flex-col items-center cursor-pointer select-none">
          <div class="w-16 h-16 rounded-2xl bg-purple-50 group-hover:bg-purple-100 border border-purple-200/60 flex items-center justify-center shadow-sm group-hover:scale-105 transition mb-2">
            <i data-lucide="book-open" class="w-7 h-7 text-purple-600 stroke-[2.2]"></i>
          </div>
          <span class="text-[11px] font-semibold text-slate-700 group-hover:text-purple-600 transition">SIMPRO</span>
        </div>

        <div onclick="navigateTo('profile')" class="group flex flex-col items-center cursor-pointer select-none">
          <div class="w-16 h-16 rounded-2xl bg-rose-50 group-hover:bg-rose-100 border border-rose-200/60 flex items-center justify-center shadow-sm group-hover:scale-105 transition mb-2">
            <i data-lucide="terminal" class="w-7 h-7 text-rose-600 stroke-[2.2]"></i>
          </div>
          <span class="text-[11px] font-semibold text-slate-700 group-hover:text-rose-600 transition">SIMANTIK</span>
        </div>

        <div onclick="navigateTo('profile')" class="group flex flex-col items-center cursor-pointer select-none">
          <div class="w-16 h-16 rounded-2xl bg-amber-50 group-hover:bg-amber-100 border border-amber-200/60 flex items-center justify-center shadow-sm group-hover:scale-105 transition mb-2">
            <i data-lucide="inbox" class="w-7 h-7 text-amber-600 stroke-[2.2]"></i>
          </div>
          <span class="text-[11px] font-semibold text-slate-700 group-hover:text-amber-600 transition">SIMPEG 5</span>
        </div>

        <div onclick="navigateTo('profile')" class="group flex flex-col items-center cursor-pointer select-none">
          <div class="w-16 h-16 rounded-2xl bg-sky-50 group-hover:bg-sky-100 border border-sky-200/60 flex items-center justify-center shadow-sm group-hover:scale-105 transition mb-2">
            <i data-lucide="plane" class="w-7 h-7 text-sky-600 stroke-[2.2]"></i>
          </div>
          <span class="text-[11px] font-semibold text-slate-700 group-hover:text-sky-600 transition">Si Cuti</span>
        </div>

        <div onclick="navigateTo('profile')" class="group flex flex-col items-center cursor-pointer select-none">
          <div class="w-16 h-16 rounded-2xl bg-emerald-50 group-hover:bg-emerald-100 border border-emerald-200/60 flex items-center justify-center shadow-sm group-hover:scale-105 transition mb-2">
            <i data-lucide="medal" class="w-7 h-7 text-emerald-600 stroke-[2.2]"></i>
          </div>
          <span class="text-[11px] font-semibold text-slate-700 group-hover:text-emerald-600 transition">SIPAKAINGE</span>
        </div>

        <div onclick="navigateTo('profile')" class="group flex flex-col items-center cursor-pointer select-none">
          <div class="w-16 h-16 rounded-2xl bg-indigo-50 group-hover:bg-indigo-100 border border-indigo-200/60 flex items-center justify-center shadow-sm group-hover:scale-105 transition mb-2">
            <i data-lucide="user" class="w-7 h-7 text-indigo-600 stroke-[2.2]"></i>
          </div>
          <span class="text-[11px] font-semibold text-slate-700 group-hover:text-indigo-600 transition">HRMS</span>
        </div>
      </div>
    </div>
...
// ==========================================
// 8. MENU LENGKAP (GRID LAYANAN & KEPEGAWAIAN)
// ==========================================
let fullMenuSearchQuery = '';

function renderFullMenuPage(container) {
  const menuSections = [
    // 1. Kepegawaian (Persis sesuai screenshot pengguna)
    {
      title: "Kepegawaian",
      categoryIcon: "users",
      badgeBg: "bg-blue-100",
      ...
      items: [
        {
          ...
          iconBg: "bg-red-50 hover:bg-red-100 border border-red-200/60",
        ...
        },
        {
          ...
          iconBg: "bg-amber-50 hover:bg-amber-100 border border-amber-200/60",
          action: () => navigateTo('profile')
        },
        {
          id: "tukin",
          ...
          iconBg: "bg-emerald-50 hover:bg-emerald-100 border border-emerald-200/60",
          action: () => navigateTo('profile')
        },
        {
          id: "simpro",
          ...
          iconBg: "bg-purple-50 hover:bg-purple-100 border border-purple-200/60",
          action: () => navigateTo('profile')
        },
        {
          id: "simantik",
          ...
          iconBg: "bg-rose-50 hover:bg-rose-100 border border-rose-200/60",
          action: () => navigateTo('profile')
        },
        {
          id: "simpeg5",
        ...
        },
        {
          ...
          iconBg: "bg-sky-50 hover:bg-sky-100 border border-sky-200/60",
          action: () => navigateTo('profile')
        },
        {
          id: "sipakainge",
        ...
        },
        {
          ...
          iconBg: "bg-indigo-50 hover:bg-indigo-100 border border-indigo-200/60",
          action: () => navigateTo('profile')
        }
      ]
    },

    // 2. Pernikahan & Keluarga Sakinah
    {
      ...
      items: [
        ...
        },
        {
          ...
          iconColor: "text-red-700",
          iconBg: "bg-red-50 hover:bg-red-100 border border-red-200/60",
          action: () => openServiceModal(23)
        }
      ]
    },

    // 3. Kemasjidan, Zakat & Wakaf
    {
      title: "Kemasjidan, Zakat & Wakaf",
      ...
      items: [
        ...
        },
        {
          ...
          iconColor: "text-amber-600",
          iconBg: "bg-amber-50 hover:bg-amber-100 border border-amber-200/60",
          action: () => openServiceModal(25)
        },
        {
          id: "kiblat",
          name: "Arah Kiblat 291°",
          icon: "compass",
          iconColor: "text-sky-600",
          iconBg: "bg-sky-50 hover:bg-sky-100 border border-sky-200/60",
          action: () => navigateTo('syariah')
        ...
        },
        {
          ...
          iconColor: "text-red-700",
          iconBg: "bg-red-50 hover:bg-red-100 border border-red-200/60",
          action: () => navigateTo('track')
        }
      ]
    },

    // 4. Syariah, IKM & Wilayah Biringbulu
    {
      title: "Layanan Syariah & Wilayah",
      ...
      items: [
        ...
        },
        {
          ...
          iconColor: "text-sky-600",
          iconBg: "bg-sky-50 hover:bg-sky-100 border border-sky-200/60",
          action: () => navigateTo('services', 'PENERANGAN_ISLAM')
        },
        {
          id: "katalog48",
          name: "48 SOP PTSP",
  ...
  const q = fullMenuSearchQuery.trim().toLowerCase();
  const filtered = q === '' 
    ? menuSections 
    : menuSections.map(sec => {
        const matches = sec.items.filter(it => it.name.toLowerCase().includes(q) || sec.title.toLowerCase().includes(q));
        return matches.length > 0 ? { ...sec, items: matches } : null;
      }).filter(Boolean);

  container.innerHTML = `
    <div class="max-w-xl mx-auto space-y-4">
      
      <!-- Top App Bar Merah Header (Persis seperti screenshot) -->
      <div class="bg-[#B71C1C] text-white px-5 py-4 rounded-2xl shadow-md flex items-center gap-3.5">
        <button onclick="navigateTo('home')" class="p-1 rounded-full hover:bg-white/20 transition active:scale-95 text-white">
          <i data-lucide="arrow-left" class="w-6 h-6"></i>
        </button>
        <h2 class="text-xl font-bold tracking-tight text-white flex-grow">
          Menu Lengkap
        </h2>
      ...
      <!-- Search Input Bar (Pill shaped, persis seperti screenshot) -->
      <div class="relative">
        <i data-lucide="search" class="w-5 h-5 absolute left-4 top-3.5 text-slate-400"></i>
        <input type="text" id="fullMenuSearchInput" value="${fullMenuSearchQuery}" 
          placeholder="Cari layanan..."
          oninput="handleFullMenuSearch(this.value)"
          class="w-full pl-12 pr-10 py-3 rounded-full bg-slate-100 border border-slate-200 focus:outline-none focus:ring-2 focus:ring-red-700 focus:bg-white text-sm text-slate-800 placeholder-slate-400 shadow-inner">
        ${fullMenuSearchQuery ? `
          <button onclick="handleFullMenuSearch('')" class="absolute right-3.5 top-3.5 text-slate-400 hover:text-slate-600">
            <i data-lucide="x" class="w-4 h-4"></i>
          </button>
        ` : ''}
      </div>

      <!-- Category Cards with 3-Column Grid of Icons (Persis seperti layout screenshot) -->
      <div class="space-y-5">
        ${filtered.map(section => `
          <div class="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-sm">
            ...
            <div class="flex items-center gap-3 mb-6">
              <div class="w-11 h-11 rounded-2xl ${section.badgeBg} ${section.badgeColor} flex items-center justify-center shrink-0 shadow-sm">
                <i data-lucide="${section.categoryIcon}" class="w-5 h-5"></i>
              </div>
              <div>
                ...
                <span class="text-xs text-slate-400 font-medium">
                  ${section.items.length} layanan
                </span>
              </div>
            </div>

            <!-- 3-Column Grid of Icons (Persis seperti screenshot pengguna) -->
            <div class="grid grid-cols-3 gap-y-6 gap-x-3 text-center">
              ${section.items.map(item => `
                <div onclick="triggerMenuItem('${item.id}')" class="group flex flex-col items-center cursor-pointer select-none">
                  <!-- Rounded Square Pastel Container -->
                  <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl sm:rounded-3xl ${item.iconBg} flex items-center justify-center shadow-sm group-hover:shadow-md group-hover:scale-105 group-active:scale-95 transition-all duration-200 mb-2">
                    <i data-lucide="${item.icon}" class="w-7 h-7 sm:w-8 sm:h-8 ${item.iconColor} stroke-[2.2]"></i>
                  </div>
                  <!-- Label Text 2 lines -->
                  <span class="text-[11px] sm:text-xs font-semibold text-slate-700 leading-tight group-hover:text-red-800 transition max-w-[85px] break-words">
                    ${item.name}
                  </span>
                </div>
              `).join('')}
  ...
  window.triggerMenuItem = function(id) {
...
function handleFullMenuSearch(val) {
  fullMenuSearchQuery = val;
  renderFullMenuPage(document.getElementById('appContent'));
  const input = document.getElementById('fullMenuSearchInput');
  if (input) {
    input.focus();
